# GLEAN AI OUTCOMES MANAGER — INTERVIEW PACKAGE
...
The result: 105 validated problem-solution pairs, 93 knowledge library entries, 7 production agents, and three active projects shipping real outcomes — not demos.
...
That's exactly what Glean needs — someone who can partner with executives and end users, design AI agents that solve real problems, and ship measurable business outcomes, not just demos."
...
**What This Proves**: You don't just talk about agentic systems — you built one, validated it, and shipped outcomes.
...
- Rex — Architecture agent
- Therizinosaurus (Theri) — Build agent
- Velociraptor (Raptor) — Debug agent
- Yutyrannus (Yuty) — Narrative/GTM agent
- Ankylosaurus (Anky) — Validation agent
- Parasaurolophus (Para) — Monitoring agent
...
The key difference from a demo: Palette has promotion/demotion logic. Agents get promoted from UNVALIDATED → WORKING → PRODUCTION based on success rates. If they fail, they get demoted. That's production, not a demo."
...
**Answer**:
"At AWS, I led Analytics GTM for Public Sector, working with government and education customers. I founded the AWS Data Leadership Forum — 291+ senior data leaders, 98+ CxOs.
...
- +17% attendance (153 → 179 per session)
...
2. **Efficiency metrics**: Is the AI saving time or reducing effort?
   - Time saved (e.g., proposal writing: 8 hours → 4 hours)
   - Tasks completed (e.g., 10 proposals per week → 15 proposals per week)
...
- <50% weekly usage after Week 6 → stop
- <30% time savings → stop
- <4.0 satisfaction score → stop"
...
**Answer**:
"I built Palette — a three-tier agentic system — over 2.5 years. It has 7 production agents:
...
- Promotion/demotion logic (UNVALIDATED → WORKING → PRODUCTION based on success rates)
...
**Days 61-90: Scale**
- Lead 5+ customer engagements end-to-end (discovery → pilot → rollout)
...
- Routed to Yutyrannus (Yuty) — Narrative/GTM agent

**Step 3: Research Directive**
- Yuty created a research directive for Argentavis (Argy) — Research agent
- Argy researched 127 AI companies, mapped them to Palette RIUs, and validated market demand

**Step 4: Build**
- Therizinosaurus (Theri) — Build agent created:
...
**Step 5: Validation**
- Ankylosaurus (Anky) — Validation agent checked for coherence, accuracy, and completeness
...
2. "What's the typical customer engagement? (Discovery → pilot → rollout timeline)"
...
"I'm excited about this role because it combines everything I'm good at: designing AI solutions, working with customers, and shipping measurable outcomes. I've spent 2.5 years building Palette — a production agentic system — and 4 years enabling AI adoption at AWS. I know how to translate customer problems into AI solutions, build those solutions with customers, and measure outcomes that matter to their business. That's exactly what Glean needs, and I'm ready to start."
